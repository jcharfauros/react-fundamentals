        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outside APIs, and other functions which may use sstem resources.</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
