...
const PropsDemo = () => {
    ...
    const toggleBackgroundColor = () => {
        backgroundColor === 'purple' ? setBackgroundColor('lightseagreen') : setBackgroundColor('purple');
    }
...
FunctionalComponent.propTypes = {
    ...
    seletedStyle : PropTypes.string.isRequired
}
